...
function ShareButton() {
  ...
  return (
    <button
      onClick={handleShare}
      className="flex items-center space-x-3 px-4 py-2 rounded-lg bg-gradient-to-r from-blue-50 to-purple-50 hover:from-blue-100 hover:to-purple-100 transition-all duration-300 border border-blue-200 hover:border-blue-300"
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-3">
            {/* Header */}
            <div className="bg-white/80 backdrop-blur-sm rounded-xl p-8 shadow-lg border border-gray-200 mb-8">
              <div className="flex items-center justify-between mb-6">
                <div className="flex flex-wrap gap-2">
                  {post.categories.map((category) => (
                    <span
                      key={category}
                      className="px-4 py-2 border-2 border-gray-300 rounded-full text-sm font-medium text-gray-700 bg-white/80 backdrop-blur-sm"
                    >
                      {category}
                    </span>
                  ))}
              ...
              <h1 className="text-3xl lg:text-4xl xl:text-5xl font-bold text-black leading-tight mb-6 tracking-tight">
                {post.title}
              </h1>
            </div>
            ...
            <div className="mt-8 bg-white/80 backdrop-blur-sm rounded-xl p-8 shadow-lg border border-gray-200">
              ...
              <div className="mb-8">
                ...
                <div className="flex items-start space-x-6">
                  <div className="flex-shrink-0">
                    <div className="w-20 h-20 rounded-full bg-gradient-to-r from-blue-600 to-purple-600 flex items-center justify-center overflow-hidden shadow-lg">
                      <Image
              ...
              <div className="flex items-center justify-between pt-6 border-t border-gray-200">
                <Link href="/blogs">
                  <Button 
                    variant="outline" 
                    className="flex items-center gap-2 bg-white hover:bg-gray-50 border-2 border-gray-300 hover:border-gray-400 transition-all duration-300"
                  >
